...
ath.intl = {
	...
	pt_br: {
		ios: 'Para adicionar este app ao seu iPhone, clique neste botão e então em <strong>Tela de início</strong>.',
		android: 'Para adicionar este app ao seu Android, abra o menu de opções do navegador e selecione <strong>Adicionar à tela inicial</strong>. <small>O menu pode ser acessado pressionando o "menu" button se o seu dispositivo tiver um, ou selecionando o ícone %icon no canto superior direito.</small>'
	},
